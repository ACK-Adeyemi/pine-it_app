...
2. **Deep links opened category/search pages (PLPs), not advert pages (PDPs).** Every homeUrl now points at a **verified live single-ad page**, captured and cross-checked against the card's facts at build time:
   ...
   - Cazoo → `https://www.cazoo.co.uk/cars-for-sale/79613297/` — a **real single-car PDP supplied by the product owner**, whose page figures (2017 Fiesta 1.0 EcoBoost 140 ST-Line 5dr, £4,595, 75,000 warranted miles, Manual Petrol Hatchback, Red, Ghost Motors Ltd, Cleckheaton BD19 5BT) were transcribed by the owner and now populate the card verbatim. Cazoo's bot-wall prevents machine verification, so provenance is owner-supplied rather than scraped — recorded here for transparency.
